...
int sdrpp_main(int argc, char* argv[]) {
    ...
    defConfig["fonts"]["Roboto"]["path"] = "/fonts/Roboto-Medium.ttf";
    defConfig["fonts"]["Roboto"]["size"] = 16.0f;
    defConfig["baseFonts"] = json::array();
    defConfig["baseFonts"][0] = "Roboto";
    defConfig["bigFonts"] = json::array();
    defConfig["bigFonts"][0] = "Roboto";
    defConfig["hugeFonts"] = json::array();
    defConfig["hugeFonts"][0] = "Roboto";
